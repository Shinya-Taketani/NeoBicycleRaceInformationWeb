...
final class Bt03e07Contract
{
    public const NAME = 'BT-03E-07-P1-FROZEN-DIRECT-POSITION-MODEL';

    public const CALCULATION_VERSION = 'BT03E07-P1-FROZEN-DIRECT-POSITION-v1';

    public const OBJECTIVE_VERSION = 'BT03E07-DIRECT-POSITION-SOFTMAX-v1';

    public const OPTIMIZER_VERSION = 'BT03E07-FISTA-DIRECT-POSITION-v1';

    public const LAMBDA_SELECTION_VERSION = 'BT03E07-SHARED-ONE-SE-P2-P3-v1';

    public const PROBABILITY_VERSION = 'BT03E07-DIRECT-POSITION-PROBABILITY-v1';

    public const DECODER_VERSION = 'BT03E07-P1-FROZEN-DIRECT-P23-v1';

    public const ARTIFACT_VERSION = 'BT03E07-DEVELOPMENT-ARTIFACT-v1';

    public const PREDICTION_MANIFEST_VERSION = 'BT03E07-PREDICTION-SEMANTIC-MANIFEST-v1';
    ...
    /** @var list<string> */
    public const POSITIONS = ['POSITION_2', 'POSITION_3'];
    ...
    public static function plan(): array
    {
        return [
            ...
            'p2_direct_formula' => 'D2(i)=softmax(U2 over every entrant)',
            'p3_direct_formula' => 'D3(i)=softmax(U3 over every entrant)',
            'candidate_set' => 'ALL_ENTRANTS_WITHOUT_TEACHER_FORCED_EXCLUSION',
            'pair_objective' => 'argmax distinct(b,c), b,c!=winner [D2(b)+D3(c)]',
            'primary_tie_rule_version' => self::PRIMARY_TIE_RULE_VERSION,
            'supporting_tie_rule_version' => self::SUPPORTING_TIE_RULE_VERSION,
            'positions_fitted' => self::POSITIONS,
            'stat01_anchor' => 'RACE_SCORE_Z coefficient=1.0 fixed for P2 and P3',
            'incremental_stats' => self::STAT_CODES,
            'lambda_grid' => self::LAMBDA_GRID,
            'fit_execution_order' => self::FIT_EXECUTION_ORDER,
            'lambda_selection' => 'SHARED_ONE_SE_POSITION_EQUAL_YEAR_EQUAL_P2_P3_ONLY',
            'solver_constants' => [
            ...
            'outer_folds' => [
                '2024' => 'inner 2022->2023; refit 2022-2023; predict 2024',
                '2025' => 'inner 2022->2023 + 2022-2023->2024; refit 2022-2024; predict 2025',
            ],
