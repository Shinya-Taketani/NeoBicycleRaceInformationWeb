...
class Store
{
    public const INVENTORY = ['contract.json', 'candidate-grid.json', 'code.json', 'sources.json',
        ...
        'outcome-sources.json', 'fixed-outcome-seals.json', 'outcome-source-trust-audit.json',
        'baseline-2025.json', 'transfer-2025.json', 'coefficient-curve-2025.json', 'coefficient-curve-2025.csv',
