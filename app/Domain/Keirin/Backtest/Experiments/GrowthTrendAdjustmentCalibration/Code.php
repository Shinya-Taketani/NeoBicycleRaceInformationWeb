...
class Code
{
    public function capture(): array
    {
        ...
        foreach (['TacticalHistory', 'TacticalHistoryFinal'] as $folder) {
        ...
        foreach (['Calculators/Bt03e03ProbabilityScorer', 'Calculators/Bt03e03CompensatedSum', 'Calculators/Bt03e02CompensatedSum',
            ...
            'Experiments/TacticalPredictionPipeline/ArtifactStore', 'Experiments/TacticalMeetingGradeAnalysis/Classification',
            'Experiments/GrowthTrendScoreSource/OuterSource', 'Experiments/GrowthTrendScoreSource/Contract',
            'Experiments/GrowthAdjustmentCalibration/Metrics', 'Experiments/GrowthAdjustmentCalibration/Contract',
            'Experiments/GrowthAdjustmentCalibration/Engine'] as $name) {
            $paths[] = app_path('Domain/Keirin/Backtest/'.$name.'.php');
        }
        $paths[] = app_path('Console/Commands/Keirin/GrowthTrendAdjustmentCalibrationCommand.php');
        $files = [];
