...
{
    public function __construct(private readonly Objective $objective, private readonly ?\Closure $auditSink = null) {}

    public function withAudit(callable $sink): self
    {
        return new self($this->objective, \Closure::fromCallable($sink));
    }
     ...
     */
    public function fitPath(callable $raceSource, Layout $layout): array
    {
    ...
    private function runPath(
        ...
        foreach (Bt03e03Contract::FIT_EXECUTION_ORDER as $lambda) {
            ...
            if ($this->auditSink !== null) {
                ($this->auditSink)($statusesByExecution[$key]);
            }
