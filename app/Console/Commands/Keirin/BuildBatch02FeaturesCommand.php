...
use App\Domain\Keirin\Statistics\Services\Batch02FeatureBuildService;
use DateTimeImmutable;
use Illuminate\Console\Command;
use InvalidArgumentException;
use Throwable;

class BuildBatch02FeaturesCommand extends Command
{
    protected $signature = 'keirin:statistics:build-batch02
        ...
        {--dry-run : Calculate all five statistics without writing statistic tables}';

    protected $description = 'Build existing-database Batch02 player-history statistics.';

    public function handle(Batch02FeatureBuildService $service): int
    {
        try {
        ...
        foreach ($result->stats as $stat) {
            ...
            $this->line(
                ...
                ." partial_history={$stat->partialHistoryCount} missing={$stat->missingCount}"
    ...
    private function validatedOptions(): Batch02BuildOptionsDto
    {
        ...
        return new Batch02BuildOptionsDto($runId, $historyFrom, $from, $to, $raceId, $chunk, (bool) $this->option('dry-run'));
    }
