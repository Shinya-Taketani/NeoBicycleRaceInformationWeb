...
final class Bt03e04DecisionDecoderCommand extends Command
{
    protected $signature = 'keirin:backtest:bt03e04
        {--plan : Display the frozen decoder-separation contract without source or database access}
        {--execute : Execute the 2024/2025 development redesign evaluation}
        {--source-bundle= : Verified BT-03E-03 v2 artifact bundle}
        {--verify-reproducibility= : Previous BT-03E-04 result.json}
        {--output-dir=/tmp : Non-Git directory for immutable execution artifacts}';

    protected $description = 'Plan or execute the fixed-probability BT-03E-04 decision decoder evaluation.';

    public function handle(Bt03e04DevelopmentEvaluationService $service): int
    {
        ...
        $this->info('BT-03E-04 DEVELOPMENT EVALUATION COMPLETE');
