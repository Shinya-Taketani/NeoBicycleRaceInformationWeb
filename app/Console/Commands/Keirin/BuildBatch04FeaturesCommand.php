...
use App\Domain\Keirin\Statistics\Services\Batch04FeatureBuildService;
use DateTimeImmutable;
use Illuminate\Console\Command;
use InvalidArgumentException;
use Throwable;

class BuildBatch04FeaturesCommand extends Command
{
    protected $signature = 'keirin:statistics:build-batch04
        ...
        {--chunk=200 : Chronological target race keyset page size (1-1000)}
        {--dry-run : Calculate STAT-39 and STAT-42 without writing statistic tables}';

    protected $description = 'Build existing-database Batch04 position and head-to-head statistics.';

    public function handle(Batch04FeatureBuildService $service): int
    {
        try {
    ...
    private function validatedOptions(): Batch04BuildOptionsDto
    {
        ...
        return new Batch04BuildOptionsDto($runId, $historyFrom, $from, $to, $raceId, $chunk, (bool) $this->option('dry-run'));
    }
