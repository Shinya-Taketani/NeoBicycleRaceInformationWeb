...
final class GrowthPointAnalysisCommand extends Command
{
    protected $signature = 'keirin:backtest:growth-point-analysis {--plan} {--execute} {--reproduce}
        {--source-bundle=} {--output-root=} {--analysis-id=}';

    protected $description = 'Read-only historical growth diagnostics, no learning or inference.';
