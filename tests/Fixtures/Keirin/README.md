...
`synthetic/race-sync-pj0301-meeting-postponed.html` is a minimal synthetic reproduction based on saved public PJ0301 responses observed for postponed four-day meetings at Sasebo and Nara in August 2023. Meeting names and encrypted parameters are fictional; the repeated first-day labels, cancellation flag, postponement message, zero `cntRace`, and populated nine-race metadata shape needed for regression coverage are retained.
