...
class RaceResultParserTest extends TestCase
{
    ...
    {
        $results = (new RaceResultParser)->parse(file_get_contents(__DIR__.'/../../../../Fixtures/Keirin/race_result_normal.html'));
    ...
    {
        $results = (new RaceResultParser)->parse(file_get_contents(__DIR__.'/../../../../Fixtures/Keirin/race_result_statuses.html'));
        ...
        $this->assertSame(RaceEntryResultStatus::Withdrawn, $results[3]->status);
    ...
    public function test_it_allows_cancelled_or_unpublished_marker(): void
    {
        $this->assertSame([], (new RaceResultParser)->parse('<html><body>開催中止</body></html>'));
    }
}
