...
class Bt03e05SourceBundleTest extends TestCase
{
    ...
    private function loader(): Bt03e05SourceBundleLoader
    {
        $hasher = new CanonicalHasher;

        return new Bt03e05SourceBundleLoader($hasher, new Bt03e03ReproducibilityVerifier($hasher));
    }

    private function bundle(): Bt03e05SyntheticBundle
    {
        return new Bt03e05SyntheticBundle(sys_get_temp_dir().'/bt03e05-source-test-'.bin2hex(random_bytes(8)));
    }

    private function rewriteCsv(Bt03e05SyntheticBundle $bundle, int $entrantCount): void
    {
