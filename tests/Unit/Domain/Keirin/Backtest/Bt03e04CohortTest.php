...
class Bt03e04CohortTest extends TestCase
{
    ...
    private function spool(string $role, array $races): Bt03e04RaceSpool
    {
        $spool = new Bt03e04RaceSpool($role, sys_get_temp_dir().'/bt03e04-cohort-'.strtolower($role).'-'.bin2hex(random_bytes(8)).'.jsonl');
    ...
    {
        $reflection = new ReflectionClass(Bt03e04DevelopmentEvaluationService::class);
